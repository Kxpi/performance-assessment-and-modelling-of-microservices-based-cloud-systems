...
def percendacne_avg_time(groups, traces):
    ...
    for trace in traces:
        ...
        for span in trace["spans"]:
            min_transfer=99999
            for span2 in trace["spans"]:
                if (span2["startTime"] - span["startTime"] + span["duration"] < min_transfer) and (span2["startTime"] - span["startTime"] + span["duration"] > 0):
                    min_transfer = span["startTime"] + span["duration"] - span2["startTime"]
                    min_spanID=span2["spanID"]
            percendance_time[span["spanID"]]=[span2["spanID"], (span2["startTime"] - span["startTime"] + span["duration"])]
