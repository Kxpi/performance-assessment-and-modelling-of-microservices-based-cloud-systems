                    ...
                    <table>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{operationStats[sOpName].exec_time_average / 1000 + ' ms'}</td>
                            </tr>
                            <tr>
                                <td><b>Min duration:</b></td>
                                <td>{operationStats[sOpName].exec_time_min / 1000 + ' ms'}</td>
                            </tr>
                            <tr>
                                <td><b>Q1 duration:</b></td>
                                <td>{operationStats[sOpName].exec_time_q1 / 1000 + ' ms'}</td>
                            </tr>
                            <tr>
                                <td><b>Q2 duration:</b></td>
                                <td>{operationStats[sOpName].exec_time_q2 / 1000 + ' ms'}</td>
                            </tr>
                            <tr>
                                <td><b>Q3 duration:</b></td>
                                <td>{operationStats[sOpName].exec_time_q3 / 1000 + ' ms'}</td>
                            </tr>
                            <tr>
                                <td><b>Max duration:</b></td>
                                <td>{operationStats[sOpName].exec_time_max / 1000 + ' ms'}</td>
                            </tr>
                            <tr>
                                <td><b>95_percentile duration:</b></td>
                                <td>{operationStats[sOpName].exec_time_95_percentile / 1000 + ' ms'}</td>
                            </tr>
                            <tr>
                                <td><b>99_percentile duration:</b></td>
                                <td>{operationStats[sOpName].exec_time_99_percentile / 1000 + ' ms'}</td>
                            </tr>
                            <tr>
                                <td><b>Stdev duration:</b></td>
                                <td>{operationStats[sOpName].exec_time_stddev / 1000 + ' ms'}</td>
                            </tr>
                            <tr>
